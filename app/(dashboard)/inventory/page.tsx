...
export default function InventoryOverviewPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filter Bar */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-3 rounded-xl bg-white border border-zinc-200/90 shadow-2xs">
      ...
      {/* Main Inventory Table with Required Columns */}
      <Card>
